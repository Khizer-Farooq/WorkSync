...
export class ShiftsController {
  ...
  create(
    ...
    return this.shiftsService.create(dto, currentUser);
  }
  ...
  @UseGuards(RolesGuard)
  @Roles(UserRole.EMPLOYEE)
  active(@GetCurrentUser() currentUser: CurrentUser) {
    return this.shiftsService.getMyActiveShift(currentUser);
  }

  @Get('weekly-hours')
  getWeeklyHours(@GetCurrentUser() currentUser: CurrentUser) {
    return this.shiftsService.getWeeklyWorkedHours(currentUser);
  }
  ...
  findAll(
    ...
    return this.shiftsService.findAll(query, currentUser);
  }

  @Get(':id')
  findOne(@Param('id') id: string, @GetCurrentUser() currentUser: CurrentUser) {
    return this.shiftsService.findOne(Number(id), currentUser);
  }

  @Delete(':id')
  @UseGuards(RolesGuard)
  @Roles(UserRole.ADMIN)
  remove(@Param('id') id: string, @GetCurrentUser() currentUser: CurrentUser) {
